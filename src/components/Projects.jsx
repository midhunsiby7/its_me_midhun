            ...
            <div key={p.title} className={`projects__card glass-card reveal delay-${Math.min(i + 2, 6)}`}>
              ...
              <div className="projects__card-body">
                ...
                <div className="projects__tech">
                  {p.technologies.map((t) => <span key={t} className="projects__tech-tag">{t}</span>)}
                </div>
                <div className="projects__links">
                  ...
                  {p.apk && (
                    <a href={p.apk} target="_blank" rel="noopener noreferrer" className="projects__link">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/></svg>
                      <span>APK</span>
                    </a>
                  )}
                  {p.website && (
                    <a href={p.website} target="_blank" rel="noopener noreferrer" className="projects__link">
